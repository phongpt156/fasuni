    ...
    <div class="product-list-wrapper">
      <div class="d-flex align-items-center justify-content-center h-100">
        <div class="text-center">
          ...
          <hr class="w-25" />
          <a>
            <router-link v-for="product in lookbook.products" :key="product.master_product_id || product.id" class="product-item d-block" :to="{name: 'Product', params: {id: product.master_product_id || product.id}, query: product.color ? {color: product.color.id} : {}}">
